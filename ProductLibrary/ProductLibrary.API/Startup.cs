        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .ConfigureApiBehaviorOptions(setupAction =>
            {
                ...
                if ((context.ModelState.ErrorCount > 0) &&
                    ...
                    {
                        problemDetails.Type = "https://productlibrary.com/modelvalidationproblem";
			...
			services.Configure<MvcOptions>(config =>
            {
                ...
                {
                    newtonsoftJsonOutputFormatter.SupportedMediaTypes.Add("application/x.hateoas+json");
                }
            });
            ...
            services.AddDbContext<ProductLibraryContext>(options =>
            {
                options.UseSqlServer(
                    @"Server=(localdb)\mssqllocaldb;Database=ProductLibraryDB;Trusted_Connection=True;");
            }); 
        }
